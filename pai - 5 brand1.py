...
def raport2():
    ...
    for element1 in contracte_cu_pai_nevandut:
        ...
        if element1.grp_crg=="L":
            incasare_brand1=float(incasare_brand1)+float(element1.pai_amt)
    ...
    print "\nNoi am incasat "+str(incasare_brand1)+" EUR si ar fi trebuit sa cedam catre insurer "+str(cedare_insurer)+" EUR. Au fost "+str(rata_6F)+" contracte pe rata 6F in care PAI-ul este inclus in tarif si nu se taxeaza suplimentar."
